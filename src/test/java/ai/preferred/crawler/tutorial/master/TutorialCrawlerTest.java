...
public class TutorialCrawlerTest {
    ...
    public void testEx03CreateSession() {
        ...
        final Session session = TutorialCrawler.createSession(games);
        final List<Game> papersReturned = session.get(TutorialCrawler.GAME_LIST_KEY);
        Assertions.assertEquals(games, papersReturned,
